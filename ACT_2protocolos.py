with open("Paquetes_Redes/ethernet_ipv4_icmp_host_unreachable.bin", "rb") as f:
    ...
    for i in res:
        if res[i] != '':
            ...
            if i == 12:
                ...
                print("Direccion IP origen:",origin+'.0')
            if i == 16:
            ...
            if i == 20:
                print("Flag copy: "+res[i][0])
                print("Class:",int(res[i][1:3],2))
                print("Número:",int(res[i][2:7],2))
            if i == 21:
                print("Longitud:",int(res[i],2))
            if i == 22:
                print("Datos de opciones:",int(res[i],2))
            if i == 23:
                print("Relleno:",int(res[i],2))
